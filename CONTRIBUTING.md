# Contributing to hello-itential

Thank you for your interest in contributing to the hello-itential project! This document provides guidelines and instructions for contributing to this project.
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR-USERNAME/hello-itential.git
   cd hello-itential
   ```

2. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/itential/hello-itential.git
   ```
...
Thank you for contributing to hello-itential!
